...
public class CatalogGenerator {
	...
	public static void main(String[] args) {
		...
		for (File file : new File(".").listFiles(filter)) {
			// eCH-0006-2-0.xsd
			// 0123456789012345
			//  <uri name="http://www.ech.ch/xmlns/eCH-0020/1" uri="platform:/resource/OpenEch/src/ch/ech/xmlns/eCH-0020-1-0.xsd"/>
			...
			System.out.print("\" uri=\"platform:/resource/OpenEch/src/ch/ech/xmlns/");
		...
		for (File file : new File(".").listFiles(filter)) {
			// eCH-0006-2-0.xsd
			// 0123456789012345
			//  <system systemId="http://www.ech.ch/xmlns/eCH-0006/2/eCH-0006-2-0.xsd" uri="platform:/resource/OpenEch/src/ch/ech/xmlns/eCH-0006-2-0.xsd"/>
