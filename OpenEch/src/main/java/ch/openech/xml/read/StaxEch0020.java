...
//		}
	...
	public static void residenceChoiceOrSkip(String startName,  Person person)  {
...
//		}
	...
	public void extension( Person personToChange)  {
//		while (true) {
//			XMLEvent event = xml.nextEvent();
//			if (event.isStartElement()) {
//				StartElement startElement = event.asStartElement();
...
//		}
	...
	public void baseDeliveryPerson( Person values)  {
...
//		}
	...
	public static void birthParent(boolean father,Person person)  {
...
//		}
	...
	public static void birthPartner(Relation relation)  {
...
//		}
	...
	public void moveOutReportingDestination(Person personToChange) {
//		while (true) {
//			XMLEvent event = xml.nextEvent();
//			if (event.isStartElement()) {
//				StartElement startElement = event.asStartElement();
...
//		}
	...
	private MunicipalityIdentification federalRegister()  {
	...
	public void moveReportingAddress(Person personToChange)  {
//		while (true) {
//			XMLEvent event = xml.nextEvent();
//			if (event.isStartElement()) {
//				StartElement startElement = event.asStartElement();
...
//		}
	...
	// Swiss & Foreign
	public void eventNaturalize(String eventName)  {
...
//		}
	...
	public void changeResidenceTypeReportingMunicipality(Person personToChange)  {
//		while (true) {
//			XMLEvent event = xml.nextEvent();
//			if (event.isStartElement()) {
//				StartElement startElement = event.asStartElement();
...
//		}
	...
	private void simplePersonEvent(String eventName)  {
//		PersonIdentification personIdentification = null;
//		personToChange = null;
//		
//		while (true) {
...
//		}
	...
	private PersonIdentification simplePersonEventPerson(String eventName) {
		PersonIdentification personIdentification = null;
