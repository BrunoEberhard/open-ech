...
public class StaxEch0044 {
	...
	public static PersonIdentification personIdentification()  {
		PersonIdentification personIdentification = new PersonIdentification();
		//personIdentification(xml, personIdentification);
		return personIdentification;
	}
		
	public static void personIdentification(PersonIdentification personIdentification)  {
//		while (true) {
...
//		}
	...
	public static NamedId namedId() {
		NamedId namedId = new NamedId();
		//namedId(xml, namedId);
		return namedId;
	}
	
	public static void namedId(NamedId namedId) {
//		while (true) {
//			XMLEvent event = xml.nextEvent();
//			if (event.isStartElement()) {
//				StartElement startElement = event.asStartElement();
...
//		}
	...
	// also used by 98
	public static ReadablePartial datePartiallyKnown()  {
