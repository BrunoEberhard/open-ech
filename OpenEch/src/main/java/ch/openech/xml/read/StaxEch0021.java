...
//		}
	...
	public static PersonIdentification partner()  {
...
//		}
	...
	public static void relation(Person person) {
...
//		}
	...
	public static void addPlaceOfOriginAddon( List<PlaceOfOrigin> placeOfOrigins)  {
...
//		}
	...
	public static void nameOfParentAtBirth( NameOfParent nameAtBirth)  {
//		while (true) {
//			XMLEvent event = xml.nextEvent();
//			if (event.isStartElement()) {
