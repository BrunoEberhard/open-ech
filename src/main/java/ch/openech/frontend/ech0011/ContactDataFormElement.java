...
public class ContactDataFormElement extends FormLookupFormElement<ContactData> {
	...
	public Form<ContactData> createForm() {
		...
		form.line(new IdentificationFormElement(ContactData.$.identification, true));
		form.line(new MailAddressFormElement(ContactData.$.contactAddress, true));

		// wenn die Referenz geändert wird wird auch automatisch die Kontaktadresse
		// gesetzt
		// form.addDependency(ContactData.$.getReference(),
